...
| 步骤 | 任务 | 优先级 |
|------|------|--------|
| 1 | 实现 DatabaseConnector 数据库连接 | P0 |
| 2 | 实现 SchemaExtractor 基本提取功能 | P0 |
| 3 | 实现 SchemaDocGenerator 文档生成 | P0 |
| 4 | 添加采样数据获取功能 | P1 |
| 5 | 实现 SchemaEnhancer 字段描述增强 | P1 |
| 6 | 实现 RelationshipExtractor 关系提取 | P2 |
| 7 | 添加单元测试 | P1 |
...
2. **采样数据** - 帮助 LLM 理解数据格式和分布
3. **字段描述** - 解决技术字段与业务术语的映射
4. **关系图谱** - 帮助 LLM 理解多表关联查询
